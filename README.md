...
JavaScriptGarden的目的并不是要教你JavaScript。语言知识前强烈建议，以了解在本指南中的主题。学习JavaScript的基础知识，请移步[Mozilla开发者网络优秀指南](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Guide)。
